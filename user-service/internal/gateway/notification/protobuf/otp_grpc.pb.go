...
const (
	Notification_SendOTP_FullMethodName = "/Notification/SendOTP"
)
...
func (c *notificationClient) SendOTP(ctx context.Context, in *SendOTPRequest, opts ...grpc.CallOption) (*SendOTPResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendOTPResponse)
	err := c.cc.Invoke(ctx, Notification_SendOTP_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNotificationServer) SendOTP(context.Context, *SendOTPRequest) (*SendOTPResponse, error) {
